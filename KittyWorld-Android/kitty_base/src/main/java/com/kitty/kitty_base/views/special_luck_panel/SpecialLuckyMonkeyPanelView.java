...
public class SpecialLuckyMonkeyPanelView extends FrameLayout {


    private SpecialPanelItemView itemView1, itemView2, itemView3,
            itemView4, itemView5,
    ...
    public SpecialLuckyMonkeyPanelView(@NonNull Context context) {
        this(context, null);
    }

    public SpecialLuckyMonkeyPanelView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SpecialLuckyMonkeyPanelView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        inflate(context, R.layout.view_special_lucky_mokey_panel, this);
        setupView();
    }
    ...
    private void setupView() {
        try {
            List<SpecialLevelRewardModel> levelRewardModels = FormDataUtil.getSpecialLevelReward();
            itemView1 = (SpecialPanelItemView) findViewById(R.id.item1);
            itemView2 = (SpecialPanelItemView) findViewById(R.id.item2);
            itemView3 = (SpecialPanelItemView) findViewById(R.id.item3);
            itemView4 = (SpecialPanelItemView) findViewById(R.id.item4);
            itemView5 = (SpecialPanelItemView) findViewById(R.id.item5);
            itemView8 = (SpecialPanelItemView) findViewById(R.id.item8);
            itemView9 = (SpecialPanelItemView) findViewById(R.id.item9);
            itemView12 = (SpecialPanelItemView) findViewById(R.id.item12);
            itemView13 = (SpecialPanelItemView) findViewById(R.id.item13);
            itemView14 = (SpecialPanelItemView) findViewById(R.id.item14);
            itemView15 = (SpecialPanelItemView) findViewById(R.id.item15);
            itemView16 = (SpecialPanelItemView) findViewById(R.id.item16);
