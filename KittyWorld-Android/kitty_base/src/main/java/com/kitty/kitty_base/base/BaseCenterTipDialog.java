...
public class BaseCenterTipDialog extends BaseDialogFragment {
    ...
    protected int getPopUpLayoutId() {
        return R.layout.fragment_dialog_base_tip_center;
    }
    ...
    public void setContentGravtyLeft() {
        if (null != tvTipContent) {
            tvTipContent.setGravity(Gravity.LEFT);
        }
    }

    public void setContentGravtyCenter() {
        if (null != tvTipContent) {
            tvTipContent.setGravity(Gravity.CENTER);
        }
    }
