...
import com.kitty.kitty_base.base.BaseDialog;
...
/**
 * 分享邀请好友弹窗显示
 * created by Jiang on 2020/5/28 09:38
 */
public class PostShareDialog extends BaseDialogFragment {
    ...
    public static PostShareDialog newInstance() {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setStyle(DialogFragment.STYLE_NORMAL, R.style.fragment_dialog_all);
    }
    ...
    protected int getPopUpLayoutId() {
        return R.layout.activity_post_share_my;
    }
    ...
    protected void initData() {
        ...
        int[] ints = ScreenUtils.getRawScreenSize(getContext());
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(getContext().getResources(), R.drawable.post_back, options);
...
//                        String message = BuildConfig.INVITE_URL + userProfile.getId();
                        ...
                        GlideUtils.loadCirclePic(getContext(), userProfile.getAvatar(), ivUserIcon);
            ...
            rxPermissions.request(Manifest.permission.WRITE_EXTERNAL_STORAGE,
                ...
                public void accept(Boolean aBoolean) {
                    if (aBoolean) {
                        ...
                        SettingUtil.startAppSettings(mActivity);
                    }
                }
            });
        } catch (Exception e) {
