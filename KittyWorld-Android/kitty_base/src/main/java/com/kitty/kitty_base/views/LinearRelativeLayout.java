...
public class LinearRelativeLayout extends RelativeLayout {
    /**
     * 画笔
     */
    ...
    public LinearRelativeLayout(Context context) {
        this(context, null);
    }

    public LinearRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LinearRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
