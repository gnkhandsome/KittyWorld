package com.kitty.kitty_base.zxing;
...
import com.kitty.kitty_base.zxing.camera.CameraManager;
import com.kitty.kitty_base.zxing.decode.DecodeThread;
import com.kitty.kitty_base.zxing.utils.BeepManager;
import com.kitty.kitty_base.zxing.utils.CaptureActivityHandler;
import com.kitty.kitty_base.zxing.utils.InactivityTimer;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (null != bundle) {
                type = bundle.getInt(IntentConfig.TO_CAPTURE);
            }
        } catch (Exception e) {
        }
    }
...
//        扫描线动画2(补间动画)
    ...
    public void handleDecode(Result rawResult) {
        ...
        if (type == IntentConfig.GET_CAPTURE_RESULT) {
            Intent intent = new Intent();
            Bundle bundle = new Bundle();
            bundle.putString(IntentConfig.CAPTURE_RESULT, rawResult.getText());
