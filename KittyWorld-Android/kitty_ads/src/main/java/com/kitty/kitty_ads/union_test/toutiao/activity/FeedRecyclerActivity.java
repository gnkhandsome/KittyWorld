...
import com.kitty.kitty_ads.union_test.toutiao.view.ILoadMoreListener;
import com.kitty.kitty_ads.union_test.toutiao.view.LoadMoreRecyclerView;
import com.kitty.kitty_ads.union_test.toutiao.view.LoadMoreView;
    ...
    private static class MyAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            if (holder instanceof SmallAdViewHolder) {
                ...
                bindData(verticalAdViewHolder, ttFeedAd);
                if (ttFeedAd.getImageList() != null && !ttFeedAd.getImageList().isEmpty()) {
                    TTImage image = ttFeedAd.getImageList().get(0);
                    if (image != null && image.isValid()) {
        ...
        private void bindData(final AdViewHolder adViewHolder, final TTFeedAd ad) {
