...
import com.kitty.websocket.dispatcher.MainThreadResponseDelivery;
...
import com.kitty.websocket.request.RequestFactory;
...
public class WebSocketManager {
    ...
    public void send(String text) {
        ...
        LogUtil.e("WSWrapper", "sendRequest text");
        sendRequest(request);
    }
    ...
    public void send(byte[] bytes) {
        ...
        LogUtil.e("WSWrapper", "sendRequest bytes");
        sendRequest(request);
    }
    ...
    public void send(ByteBuffer byteBuffer) {
        ...
        LogUtil.e("WSWrapper", "byteBuffer");
        sendRequest(request);
    }
    ...
    void reconnectOnce() {
        if (destroyed) {
            LogUtil.e("WSWrapper", "This WebSocketManager is destroyed!");
            return;
        }
        if (mWebSocket.getConnectState() == 0) {
            LogUtil.e("WSWrapper", "reconnectOnce");
            mWebSocketEngine.connect(mWebSocket, mSocketWrapperListener);
        } else {
            if (mReconnectManager != null) {
                mReconnectManager.onConnected();
            }
            LogUtil.e("WSWrapper", "WebSocket 已连接，请勿重试。");
        }
    }
    ...
    private void sendRequest(Request request) {
        ...
        LogUtil.e("WSWrapper", "sendRequest request");
        ...
        return new SocketWrapperListener() {
            ...
            public void onConnectFailed(Throwable e) {
                ...
                if (mReconnectManager != null &&
                    ...
                    LogUtil.i("WSWrapper", "onConnectError11");
            ...
            public void onDisconnect() {
                ...
                if (mReconnectManager != null &&
                    ...
                    if (disconnect) {
                        ...
                        LogUtil.i("WSWrapper", "onDisconnecton onConnectError");
