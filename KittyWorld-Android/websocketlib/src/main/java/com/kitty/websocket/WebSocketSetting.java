...
import com.kitty.websocket.dispatcher.DefaultResponseDispatcher;
import com.kitty.websocket.dispatcher.IResponseDispatcher;
...
public class WebSocketSetting {
     ...
     * 重连次数，默认为：1次
     */
    private int reconnectFrequency = 1;
    /**
     * 消息发射器
     */
    ...
    /**
     * 设置消息发射器，不设置则默认使用 {@link com.kitty.websocket.dispatcher.MainThreadResponseDelivery}.
